...
public class AutomationPractice {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        if(FirstName.isEnabled()) {
        	FirstName.clear(); FirstName.sendKeys("Shyam");
        } else {
        ...
        if(LastName.isEnabled()) {
        	LastName.clear();LastName.sendKeys("Narwade");
        } else {
       ...
       while (itr.hasNext()) {
		...
		System.out.println("All years of birth= "+allyear);
	    }
       ...
       if(AddressFname.isEnabled()) {
    	  AddressFname.clear(); AddressFname.sendKeys("Shyam");
       } else 
         {
       ...
       if(AddressLname.isEnabled()) {
    	  AddressLname.clear(); AddressLname.sendKeys("Narwade");
       } else {
      ...
      List<WebElement> AllState = driver.findElements(By.xpath("//select[@id='id_state']//option"));
       ...
       while (itr1.hasNext()) {
		...
		System.out.println("All state of America = "+allstate);
     	}
...
//       select5.selectByVisibleText("United States");
       ...
       if(Mobilephone.isEnabled()) {
    	   Mobilephone.sendKeys("9988776622");
       } else {
